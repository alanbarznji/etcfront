  ...
  return (
    ...
    <div className="w-full lg:w-3/6">
      <Swiper
        ...
        slidesPerView={1}
        navigation={{
          nextEl: "#slider-button-right1",
          prevEl: "#slider-button-left1",
        }}
        pagination={{
          clickable: true,
          dynamicBullets: true,
      ...
      >
        {packages?.PrinterOfOffer?.map((e, index) => (
          <SwiperSlide key={`package-${index}`}>
            <div className="h-full">
              <PackageProduct product={e.Printer}/>
            </div>
          </SwiperSlide>
        ))}
      </Swiper>
